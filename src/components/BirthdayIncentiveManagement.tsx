    ...
    <div className="space-y-8">
      {!hideHeader && (
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            <h2 className="text-4xl font-black tracking-tight text-[#0F172A]">BIRTHDAY CASH INCENTIVES</h2>
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-[#0F172A]">
                ...
                <th className="px-6 py-5 text-[10px] font-black text-white uppercase tracking-[0.2em] text-center">Incentive Age</th>
              ...
              {isLoading ? (
                ...
                filteredApplications.map((app) => (
                  <tr key={app.id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-6 text-center">
                      <p className="text-sm font-bold text-slate-600">{app.incentive_tier || app.age}</p>
                    </td>
                    <td className="px-6 py-6 text-center">
                    ...
                    <td className="px-6 py-6 text-center">
                      <div className={cn(
                        ...
                        <div className={cn(
                          ...
                          (app.reg_status === 'rejected' || app.reg_status === 'disapproved') && "bg-rose-500",
                        )} />
                        {app.reg_status}
                      </div>
                    </td>
